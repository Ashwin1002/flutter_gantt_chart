...
class GanttChart extends StatelessWidget {
  ...
  final List<TasksDataModel> tasksList;
  ...
  List<Widget> buildChartBars(
      List<TasksDataModel> data, double chartViewWidth, BuildContext context) {
    List<Widget> chartBars = [];

    for (int i = 0; i < data.length; i++) {
      for (int index = 0; index < data[i].childs.length; index++) {
        debugPrint("child length => ${data[i].childs.length}");

        final childIndex = data[i].childs[index];
              ...
              children: [
                ...
                Container(
                  ...
                  margin: EdgeInsets.only(
                      ...
                      top: i == 0 ? 4.0 : 2.0,
                      bottom: i == childIndex.childs.length - 1 ? 4.0 : 2.0
                  ),
                ...
                Container(
                  decoration: BoxDecoration(
                      color: cColor.withAlpha(100), borderRadius: BorderRadius.circular(10.0)),
                  height: 25.0,
                  ...
                  margin: EdgeInsets.only(
                      left: calculateDistanceToLeftBorder(
                          ...
                          viewRangeToFitScreen,
                      top: i == 0 ? 4.0 : 2.0,
                      bottom: i == data[i].childs.length - 1 ? 4.0 : 2.0),
  ...
  Widget buildChartForEachUser(List<TasksDataModel> userData,
      double chartViewWidth, BuildContext context) {
    ...
    return Container(
        ...
        child: Column(
          children: [
            ...
            SizedBox(
              height: chartBars.length * 29.0 + 25.0 + chartBars.length * 2,
  ...
  List<Widget> buildChartContent(double chartViewWidth, BuildContext context) {
    ...
    for (var user in tasksList) {
      ...
      if (projectsOfUser.isNotEmpty) {
        debugPrint("total widgets length => ${chartContent.length}");
      }
    }
